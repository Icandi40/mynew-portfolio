      ...
      >
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold">Sheena Lindsey-Smith</h3>
            <p className="text-sm text-muted-foreground max-w-xs">
              AI Engineer/Developer based in Maryland,
              specialized in leveraging AI solutions to I specialize in designing and deploying intelligent AI solutions
              and automation that drive efficiency, accuracy, and measurable impact and solve real-world business challenges.
            </p>
          </div>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center text-sm text-muted-foreground">
              ...
              <span>{new Date().getFullYear()} Sheena Lindsey-Smith. All rights reserved.</span>
            </div>
